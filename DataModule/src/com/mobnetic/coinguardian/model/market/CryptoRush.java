...
public class CryptoRush extends Market {
	...
	static {
		...
		CURRENCY_PAIRS.put(VirtualCurrency._42, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.BC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.POT, VirtualCurrency.TEA });
		CURRENCY_PAIRS.put(VirtualCurrency.BCX, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.BEE, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.BEER, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.CARB, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.POT });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.CRA, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.CRD, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.DOGE, new String[]{ VirtualCurrency.AUR, VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.FCK, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.GOAT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.GRUMP, new String[]{ VirtualCurrency.BTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.HRO, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.HUC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.HXC, new String[]{ VirtualCurrency.AUR, VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.ICN, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.KOI, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.LEAF, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.LMC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.LOT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.LTB, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.MIM, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.MRS, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.MRY, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.NDL, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.OIL, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.ORG, new String[]{ VirtualCurrency.BTC, VirtualCurrency.POT });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.PANDA, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.PAND, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.PENG, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.PHI, new String[]{ VirtualCurrency.BTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.PIC, new String[]{ VirtualCurrency.BTC });
		CURRENCY_PAIRS.put(VirtualCurrency.PLT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.POD, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE });
		CURRENCY_PAIRS.put(VirtualCurrency.POT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.PT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.PTC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.PWNY, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.PANDA });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.QB, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.RBBT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.FOX, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.RON, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.RUBY, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.SAT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.SBX, new String[]{ VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.STY, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.POT });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.SYN, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTB, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.TAK, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.TEA, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.PANDA, VirtualCurrency.POT });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.TFC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.THOR, new String[]{ VirtualCurrency.BTC, VirtualCurrency.LTC, VirtualCurrency.ZEU });
		CURRENCY_PAIRS.put(VirtualCurrency.TIPS, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.VMP, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.VOLT, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.VTC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC, VirtualCurrency.POT });
		CURRENCY_PAIRS.put(VirtualCurrency.XIV, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DGC });
		CURRENCY_PAIRS.put(VirtualCurrency.XXL, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		CURRENCY_PAIRS.put(VirtualCurrency.ZEIT, new String[]{ VirtualCurrency.AUR, VirtualCurrency.BTC, VirtualCurrency.DOGE, VirtualCurrency.LTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.ZTC, new String[]{ VirtualCurrency.BTC, VirtualCurrency.DOGE });
