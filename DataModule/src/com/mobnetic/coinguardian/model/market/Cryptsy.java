...
public class Cryptsy extends Market {
	...
	static {
		...
		CURRENCY_PAIRS.put(VirtualCurrency.BC, new String[]{ VirtualCurrency.BTC });
		...
		CURRENCY_PAIRS.put(VirtualCurrency.FRK, new String[]{ VirtualCurrency.LTC, VirtualCurrency.BTC });
		...
		CURRENCY_PAIRS_IDS.put("BC_BTC", 179);		
		...
		CURRENCY_PAIRS_IDS.put("FRK_LTC", 171);
