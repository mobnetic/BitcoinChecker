...
public class Gemini extends Market {
	...
	protected void parseTickerFromJsonObject(int requestId, JSONObject jsonObject, Ticker ticker, CheckerInfo checkerInfo) throws Exception {
		...
		final JSONObject latestAsk = asksArray.getJSONObject(0);
		final JSONObject latestBid = bidsArray.getJSONObject(0);

		ticker.last = (latestAsk.getDouble("price") + latestBid.getDouble("price")) / 2.0;
	}
}
