...
public class CheckerVolleyMainRequest extends GenericCheckerVolleyRequest<Ticker> {
	
	private final Market market;
	private RequestQueue requestQueue;

	public CheckerVolleyMainRequest(Market market, CheckerInfo checkerInfo, Listener<Ticker> listener, ErrorListener errorListener) {
