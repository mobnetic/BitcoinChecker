...
Otherwise you have to specify which currency pairs are supported by your new exchange. Description for this is done above, in the [Updating currency pairs on existing exchange](#updating-currency-pairs-on-existing-exchange) section.
