...
class Hydax : Market(NAME, TTS_NAME, null) {
    companion object {
        private const val NAME = "Hydax"
        private const val TTS_NAME = NAME
        private const val URL = "https://api.hydax.com/openapi/quote/v1/ticker/24hr?symbol=%1\$s"
        private const val URL_CURRENCY_PAIRS = "https://api.hydax.com/openapi/v1/brokerInfo"
    }
